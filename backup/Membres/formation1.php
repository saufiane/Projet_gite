...
?>
<?php $page_title = "Formation 1"; require_once("includes/themes/".THEME_NAME."/header.php"); ?>
...
<div class="title">
	...
	<table class="table">
	  ...
	  <tbody>
		...
		<?php endforeach; ?>
		<?php if(partial_protect($user->user_level,"759498","index.php")){ ?> 
     Has Correct Access. Place all of the html code here. 
<?php } else { ?> 
     Doesn't have the Correct Access. Display error message here. 
<?php } ?> 
	  </tbody>
	</table>
