...
<head>
    ...
    <meta name="author" content="Pascal Moreno - 2016 Easy-for.com - Paris">
								...
								<div class="container">
									...
									<div class="nav-collapse collapse navbar-responsive-collapse">
										<ul class="nav">
											...
											<li<?php echo ($current_page == "formation1") ? " class='active'" : "" ?>><a href="<?php echo WWW; ?>formation1.php">Formation 1</a></li>
											...
											<?php if($session->is_logged_in()) { ?>
												<li class="dropdown">
										          ...
										          <ul class="dropdown-menu">
										          		...
										          		<li><a href="<?php echo WWW; ?>dashboard.php?page=purchase-history">History des Achats</a></li>
