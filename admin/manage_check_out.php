...
<div class="container-fluid">
	<p><b>Gite : </b><?php echo isset($room['room']) ? $room['room'] : 'NA' ?></p>
	<p><b>Catégorie du gite : </b><?php echo $cat['name'] ?></p>
	<p><b>Prix  : </b><?php echo '$'.number_format($cat['price'],2) ?></p>
	<p><b>Reference no : </b><?php echo $ref_no ?></p>
	<p><b>Enregistré : </b><?php echo $name ?></p>
	<p><b> N° de contact : </b><?php echo $contact_no ?></p>
	<p><b>Date & heure d'enregistrement : </b><?php echo date("M d, Y h:i A",strtotime($date_in)) ?></p>
	<p><b>Date & heure de départ : </b><?php echo date("M d, Y h:i A",strtotime($date_out)) ?></p>
	<p><b>Jours : </b><?php echo $calc_days ?></p>
	<p><b>Montant (Prix * Jours) : </b><?php echo '$'.number_format($cat['price'] * $calc_days ,2) ?></p>
	
		<div class="row">
			<?php if(isset($_GET['checkout']) && $status != 2): ?>
				<div class="col-md-3">
					<button type="button" class="btn btn-primary" id="checkout">Vérifier</button>
				</div>
				<div class="col-md-3">
					<button type="button" class="btn btn-primary" id="edit_checkin">Modifier</button>
				</div>
		<?php endif; ?>	
				<div class="col-md-3">
